    ...
    >
      <AspectRatio ratio={290 / 590}>
        ...
        >
          ...
          >
            <img
              className="w-full hover:scale-125 transition duration-300 -mt-20"
              src={image}
            />
          </header>
          <section
            className="px-9 mt-2 overflow-clip cursor-pointer"
            onClick={handleRedirect}
            style={{
              gridArea: "content",
            }}
          ...
          <footer
            className="flex items-end justify-between px-4 py-8 "
            style={{
              gridArea: "price",
              alignSelf: "end",
            }}
              ...
              <TooltipTrigger className="hidden sm:block">
                <button className="rounded-full p-2 border-gray-200 border-2 z-20">
                  <PopupPreview
                    ...
                    type={type}
                  >
                    <FontAwesomeIcon className="w-5" icon={faEye} />
                  </PopupPreview>
                </button>
              </TooltipTrigger>
...
export function ItemSmall({ name, price, _id, image }: Props) {
  ...
  return (
    ...
    >
      <img className="h-full w-[80px] object-cover rounded-xl" src={image} />
      <div>
